...
- **R:**
    - Mathematical modelling focusing on the economic perspectives of **climate effects** on health (using distributed lag non-linear models & meta-regressions) (while working as a MITACs research intern) ⛅
